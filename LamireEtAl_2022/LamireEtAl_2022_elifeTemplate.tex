...
\label{fig:1}
\figdata{\href{https://github.com/owenrandlett/lamire_2022/blob/main/Figure 1—source data 1 - Small molecule library.csv}{Small molecule library}, Selleckchem Bioactive: 2100 FDA-approved/FDA-like small molecules}
\label{table:1}
\figdata{\href{https://github.com/owenrandlett/lamire_2022/blob/main/Figure 1—source data 2 - Behavioural fingerprints.csv}{Behavioural fingerprints} for viable compounds}
\label{table:2}
